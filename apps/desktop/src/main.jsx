...
function ScheduleView({ rows, leftWidth, setLeftWidth, density, setDensity, zoom, setZoom, outlineMode, setOutlineMode, action, notice, activeTool }) {
