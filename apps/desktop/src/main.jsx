...
const navItems = [
  ...
  ['Dashboard', LayoutDashboard], ['My Tasks', ClipboardList], ['Tags', ListFilter], ['Notifications', Bell], ['Documents', ClipboardList], ['Comments', MessageCircle], ['Attachments', Paperclip], ['Risks', AlertTriangle], ['Issues', CircleHelp]
];
