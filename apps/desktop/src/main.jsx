...
function App() {
  ...
  const logEvent = (action, detail) => setEvents((current) => [{ id: Date.now(), actor: 'You', action, detail, time: new Date().toLocaleString() }, ...current].slice(0, 100));
