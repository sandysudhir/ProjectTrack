...
function AutofillDialog({ rows, onClose, onGenerate }) {
  const [targetId, setTargetId] = useState(String(rows.find((row) => row.type === 'summary')?.id || rows[0]?.id || ''));
