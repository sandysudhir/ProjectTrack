...
| GOV-01 | Human approval required at each front-end UI/UX gate | P0 | Confirmed | A | P01 Architecture and governance / G-ARCH-01 | NOT STARTED | NOT VALIDATED | NOT REQUIRED | Agent may continue without approval → Hard stop and signed approval record |
| GOV-02 | Independent validation task separate from implementation task | P0 | Confirmed | A | P01 Architecture and governance / G-ARCH-01 | NOT STARTED | NOT VALIDATED | NOT REQUIRED | Self-validation bias → Separate validation prompt and reports |
| GOV-03 | No phase advances without evidence-backed checkpoint | P0 | Confirmed | A | P01 Architecture and governance / G-ARCH-01 | NOT STARTED | NOT VALIDATED | NOT REQUIRED | Status drift → Checkpoint record linked to commit SHA |
