...
| UI-01 | Spreadsheet + timeline | P0 | Confirmed | A/B | P04 Schedule View structure / UI-02 | PARTIAL (P02 shell) | PASS (UI-01 shell) | PENDING | Full editing, geometry and scheduler behavior remain for P04/P05 → `governance/ui_evidence/UI-01R/` + coverage mapping and shell dialogs |
...
| UI-14 | All Projects and individual project tabs in one workspace | P0 | Confirmed | B | P04 Schedule View structure / UI-02 | PARTIAL (P02 shell) | PASS (UI-01 shell) | PENDING | Canonical projection behavior remains for P04/P07 → `governance/ui_evidence/UI-01R/` + coverage mapping and shell dialogs |
